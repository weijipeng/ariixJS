...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _touchScroll = __webpack_require__(301);
	...
	var index = function () {
		function index() {
			...
			this.loadScroll().then(_touchScroll2.default.initScroll(this.scroll_el));
			this.loadCate();
		}
	  ...
	  */
						...
						success: function success(res) {
							if (res && res.status) {
								...
								//加载图片
								{
									...
									(0, _jquery2.default)(self.scroll_el + ' ul').html(arr.join(''));
								}
	   ...
	   */
			...
			key: 'loadCate',
			value: function loadCate() {
				var self = this;
				_jquery2.default.ajax({
					type: 'get',
					url: '/js/data_productCate.js',
					async: true,
					dataType: 'json',
					success: function success(res) {
						if (res && res.status) {
							...
							//加载分类
							{
								...
								try {
									for (var _iterator2 = cate[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
										var c = _step2.value;

										arr.push('<a href="' + c.id + '">\n\t\t\t\t\t\t\t\t\t<li>\n\t\t\t\t\t\t\t\t\t<dd><img src="/images/' + c.catePicture + '"></dd>\n\t\t\t\t\t\t\t\t\t<dt>' + c.cateName + '</dt>\n\t\t\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t\t</a>');
									}
								} catch (err) {
								...
								(0, _jquery2.default)(self.cate_el).html(arr.join(''));
							}
							//加载在首页显示的分类内容
							{
								var _arr = new Array();
								...
								try {
									for (var _iterator3 = cate[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
										var _c = _step3.value;

										_arr.push(_c.cateDetail + '</br>');
									}
								} catch (err) {
								...
								(0, _jquery2.default)(self.cateDetail_el).html(_arr.join(''));
							}
						}
					},
					error: function error(err) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TouchScroll = function () {
		...
		_createClass(TouchScroll, null, [{
			key: 'initScroll',
			value: function initScroll(el) {
				(0, _jquery2.default)(document).ready(function () {
					window.jQuery('.main_image').touchSlider({
						flexible: true,
						speed: 200,
						btn_prev: (0, _jquery2.default)("#btn_prev"),
						btn_next: (0, _jquery2.default)("#btn_next"),
						paging: (0, _jquery2.default)(".flicking_con a"),
						counter: function counter(e) {
							(0, _jquery2.default)(".flicking_con a").removeClass("on").eq(e.current - 1).addClass("on");
						}
					});
				});
			}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _case = __webpack_require__(303);

	var _case2 = _interopRequireDefault(_case);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var c = new _case2.default();
