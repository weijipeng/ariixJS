...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _category = __webpack_require__(302);

	var _category2 = _interopRequireDefault(_category);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var c = new _category2.default();
	c.initCategoryMap();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _category_base = __webpack_require__(303);

	var _category_base2 = _interopRequireDefault(_category_base);
	...
	var Category = function (_mix) {
		_inherits(Category, _mix);
		...
		function Category() {
			...
			_this.cate_detail_el = '.layout .content .headline';
			_this.product_map = new Map();
			_this.product_el = '.layout .content_main';
			return _this;
		}
	  ...
	  * */
		...
		_createClass(Category, [{
			key: 'initCategoryMap',
			value: function initCategoryMap() {
				var self = this;
				//ajax请求分类//将分类数据保存为本地map//显示分类
				self.getAllCate().then(self.categoryArray2Map).then(self.showCategory).then(self.initEvent).then(function () {
					var i = self.request('cateId') || location.hash.substring(1);
					if (i !== '') {
						(0, _jquery2.default)('.aixlist > ul > a[data-cateId="' + i + '"]').click();
					} else {
						(0, _jquery2.default)('.aixlist > ul > a:first-child').click();
					}
				});
			}
	   ...
	   * */
			...
			value: function loadProduct() {
				...
				if (self.product_map.size === 0) {
					...
					self.getProduct().then(self.productuArray2Map.bind(self)).then(self.showProductes.bind(self)).then(function () {});
				} else {
				...
				return new Promise(function (resolve, reject) {
					...
					try {
						for (var _iterator3 = m.entries()[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
							...
							(0, _jquery2.default)('.layout .aixlist > ul').on('click', 'a[data-cateId="' + k + '"]', v.loadProduct.bind(v));
						}
						//返回键跳转到 产品首页
					} catch (err) {
		...
		return Category;
	}(mix(_interface2.default, _category_base2.default));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Base = function () {
	   ...
	   * */
			...
			value: function showCategory() {
				...
				return new Promise(function (resolve, reject) {
					...
					try {
						for (var _iterator = _category2.default.cate_map.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
					...
					(0, _jquery2.default)(_category2.default.cate_el).html(arr.join(''));
					resolve.call(self);
				});
			}
		}, {
			key: 'categoryArray2Map',
			value: function categoryArray2Map(arr) {
				return new Promise(function (resolve, reject) {
					var m = _category2.default.cate_map;
					var _iteratorNormalCompletion2 = true;
					var _didIteratorError2 = false;
					var _iteratorError2 = undefined;
					...
					try {
						for (var _iterator2 = arr[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
							...
							c.catePicture = cate.catePicture;
							c.cateDetail = cate.cateDetail;
							c.isShow = cate.isShow;
							c.rank = cate.rank;
			...
			key: 'productuArray2Map',
			value: function productuArray2Map(arr) {
				var self = this;
				return new Promise(function (resolve, reject) {
					var _iteratorNormalCompletion3 = true;
					var _didIteratorError3 = false;
	   ...
	   * */
			...
			key: 'showCategoryDetail',
			value: function showCategoryDetail() {
				var self = this;
				(0, _jquery2.default)(self.cate_detail_el).html('<h3>' + self.cateName + '</3>' + self.cateDetail);
			}
			...
			value: function showProductes() {
				...
				return new Promise(function (resolve, reject) {
					...
					try {
						...
						for (var _iterator4 = self.product_map.values()[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
							var v = _step4.value;
					...
					(0, _jquery2.default)('.layout .content_main').html(arr.join(''));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Interface = function () {
	   ...
	   */
			...
			key: 'getProduct',
			value: function getProduct(cate_id) {
				var self = this;
				return new Promise(function (resolve, reject) {
					_jquery2.default.ajax({
						type: 'get',
